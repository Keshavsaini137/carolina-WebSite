  ...
  <div class="container">
    <div class="row">
      <div class="col-md-4">
        ...
        <p class="text-justify">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Beatae voluptatem nisi possimus autem commodi ex doloribus consectetur!</p>
      </div>
      ...
      <div class="w-100"></div>
      <hr class="w-100">
      <p class="copyright text-center w-100">Carolina Spa & Salon 2018</p>
    </div><!--.row-->
  </div><!--.container-->
</footer>
